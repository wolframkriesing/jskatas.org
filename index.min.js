...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.loadViaAjax=void 0;const e=e=>window.fetch(e).then(e=>e.json()).catch(e=>onLoaded(e));exports.loadViaAjax=e;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("preact"),t=s(require("./header")),n=s(require("./footer"));function s(e){return e&&e.__esModule?e:{default:e}}class a extends e.Component{render(){let{kataBundles:s}=this.props;return(0,e.h)("div",null,(0,e.h)(t.default,null),(0,e.h)("p",{style:{padding:"1rem"}},"I learned ES6 by writing it and failing. Out of this the es6katas evolved. And since, this allowed me to always again go back and (re-)learn ES6 I wrote katas for ES8, later ES1 (I always got the ",(0,e.h)("code",null,"sort()")," function wrong). At some point I started to learn a very expressive assertion library ",(0,e.h)("a",{href:"https://github.com/rluba/hamjest"},"hamjest")," by writing katas for it, and so this page came about.",(0,e.h)("br",null),"Enjoy and I hope you have fun learning with it.",(0,e.h)("br",null),"Wolfram Kriesing"),s.map(({kataGroups:t,name:n})=>(0,e.h)(r,{name:n,groups:t})),(0,e.h)(n.default,{katasCount:100}))}}exports.default=a;class r extends e.Component{render(){const{groups:t,name:n}=this.props;return(0,e.h)("div",null,(0,e.h)("h2",null,n),t.all().map(n=>(0,e.h)(l,{group:n,isNewestKataCheck:t.isNewestKata.bind(t),key:n.name})))}}class l extends e.Component{render(){const t=this.props.group,{isNewestKataCheck:n}=this.props;return(0,e.h)("div",{className:"group"},(0,e.h)("h3",null,t.name),t.katas.map(t=>(0,e.h)(o,{kata:t,isNewest:n(t),key:t.id})))}}class o extends e.Component{render(){const{kata:t,isNewest:n}=this.props,{url:s,name:a,level:r}=t,l=n?(0,e.h)("span",{className:"notification-bubble new"},"new"):"BEGINNER"===r?(0,e.h)("span",{className:"notification-bubble easy"},"easy"):"";return(0,e.h)("div",{className:"kata"},l,(0,e.h)("a",{href:s,target:"_blank"},(0,e.h)(i,{name:a})),(0,e.h)(h,{kata:t}))}}class i extends e.Component{render(){const t=[];function n(n){return(0,e.h)("span",{className:t},n)}const{name:s}=this.props;if(s.startsWith("`")&&s.endsWith("`")){return t.push("code"),n(s.substr(1,s.length-2))}return n(s)}}class h extends e.Component{render(){const{kata:t}=this.props;return(0,e.h)("span",{className:"details"},(0,e.h)("h3",null,t.name," (#",t.id,")"),(0,e.h)("p",null,t.description),"Difficulty: ",t.level.toLowerCase(),(0,e.h)("br",null),(0,e.h)(u,{links:t.links}))}}class u extends e.Component{render(){const{links:t=[]}=this.props;return 0===t.length?null:(0,e.h)("section",null,(0,e.h)("h3",null,"Links for futher reading"),(0,e.h)("ul",null,t.map(t=>(0,e.h)("li",null,(0,e.h)("a",{href:t.url},t.comment)))))}}
},{"preact":"Gr1O","./header":"4aS9","./footer":"+unH"}],"ODXJ":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;const e=e=>`http://tddbin.com/#?kata=es6/language/${e}`;class t{static fromRawItem(r){let i=new t;return i.initializePropertiesFromRawItem(r),i.url=e(r.path),i.id=Number.parseInt(i.id),i}initializePropertiesFromRawItem(e){Object.keys(e).forEach(t=>this[t]=e[t])}}exports.default=t;
},{}],"JaJ7":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=e(require("./kata.js"));function e(t){return t&&t.__esModule?t:{default:t}}class a{static withKatas(t,e){const s=new a;return s.name=t,s.createKatas(e),s.sortByName(),s}createKatas(e){this.katas=e.map(t.default.fromRawItem)}sortByName(){this.katas.sort(s)}get highestId(){return this.lastId}get lastId(){return this.katas[this.katas.length-1].id}}exports.default=a;const s=(t,e)=>t.id<e.id?-1:1;
},{"./kata.js":"ODXJ"}],"IHYm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;class t{constructor(){this.groups=[]}all(){return this.groups}get length(){return this.all().length}static fromObject(e){const s=new t;return s.initializePropertiesFromRawObject(e),s.sortByNumberOfLinks(),s.moveGroupWithNewestKataToBeginning(),s}isNewestKata(t){return Number.parseInt(t.id)===this.highestKataId()}addGroup(t){this.groups.push(t)}initializePropertiesFromRawObject(t){Object.keys(t).forEach(e=>this.addGroup(t[e]))}sortByNumberOfLinks(){this.groups.sort(function(t,e){const s=t.katas.length,r=e.katas.length;return s===r?e.name<t.name?1:-1:r-s})}highestKataId(){return this.eachGroupsHighestKataId().sort((t,e)=>e-t)[0]}eachGroupsHighestKataId(){return this.groups.map(t=>t.highestId)}groupWithNewestKata(){return this.groups.reduce((t,e)=>t.highestId>e.highestId?t:e,{highestId:0})}moveGroupWithNewestKataToBeginning(){this.moveToBeginning(this.groupWithNewestKata())}moveToBeginning(t){this.groups=[t,...this.groups.filter(e=>!Object.is(e,t))]}}exports.default=t;
},{}],"FnuW":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=r(require("./katagroup.js")),t=r(require("./katagroups.js"));function r(e){return e&&e.__esModule?e:{default:e}}class u{static toKataGroups(e){return t.default.fromObject(s(e))}}function s(t){const r=t.groups;return Object.keys(r).map(t=>{let u=r[t].items;return e.default.withKatas(t,u)})}exports.default=u;
},{"./katagroup.js":"JaJ7","./katagroups.js":"IHYm"}],"IxXz":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.FLAT_METADATA_URL=exports.GROUPED_METADATA_URL=exports.metadataUrls=void 0;const s="http://katas.tddbin.com",e={es1:`${s}/katas/es1/language/__grouped__.json`,es6:`${s}/katas/es6/language/__grouped__.json`,es8:`${s}/katas/es8/language/__grouped__.json`,hamjest:`${s}/katas/libraries/hamjest/__grouped__.json`};exports.metadataUrls=e;const a=`${s}/katas/es6/language/__grouped__.json`;exports.GROUPED_METADATA_URL=a;const _=`${s}/katas/es6/language/__all__.json`;exports.FLAT_METADATA_URL=_;
},{}],"Focm":[function(require,module,exports) {
"use strict";var a=require("preact"),e=require("./ajax.js"),t=n(require("../components/page.js")),s=n(require("../rawmetadata.js")),r=require("../config.js");function n(a){return a&&a.__esModule?a:{default:a}}function i(e,r){if(e)console.log(e);else{const e=document.getElementById("app"),n=r.map(({data:a,name:e})=>({name:e,kataGroups:s.default.toKataGroups(a)}));(0,a.render)((0,a.h)(t.default,{kataBundles:n}),e)}}const d=async()=>{const a=[];a.push({name:"ECMAScript 1",data:await(0,e.loadViaAjax)(r.metadataUrls.es1)}),a.push({name:"ECMAScript 6",data:await(0,e.loadViaAjax)(r.metadataUrls.es6)}),a.push({name:"ECMAScript 8",data:await(0,e.loadViaAjax)(r.metadataUrls.es8)}),a.push({name:"Assertion Library Hamjest",data:await(0,e.loadViaAjax)(r.metadataUrls.hamjest)}),i(null,a)};d();
},{"preact":"Gr1O","./ajax.js":"PSwN","../components/page.js":"eJft","../rawmetadata.js":"FnuW","../config.js":"IxXz"}]},{},["Focm"], null)